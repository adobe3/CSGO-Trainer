...
void d2oSetup(HWND tWindow) {
	...
	RegisterClass(&wc);
	overlayWindow = CreateWindowEx(WS_EX_TOOLWINDOW | WS_EX_LAYERED | WS_EX_TRANSPARENT | WS_EX_TOPMOST,
		wc.lpszClassName, L"NVIDIA GeForce Overlay DT", WS_POPUP, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT,
